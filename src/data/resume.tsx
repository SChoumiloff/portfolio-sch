...
export const DATA = {
  ...
  summary:
    "Mi-2024, j'ai quitté mon job d'ingénieur data à la forge, pour développer à plein temps mon premier SaaS [Analyzeurbiz](https://analyzeurbiz.com). J'ai réalisé un [master en base de données et intelligence artificielle à l'université de Bourgogne.](/#education). Je suis également disponible pour des missions freelance à courte et moyenne durée.",
  avatarUrl: "/me.png",
  skills: [
    "Python",
    "React",
